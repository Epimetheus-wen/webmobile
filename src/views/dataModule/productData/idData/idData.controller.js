...
export default {
    ...
    mounted() {
        ...
        this.getLineData(this.employ.Time1.value, this.employ.Time2.value, this.account.n + 1, )
            .then((res) => {
    ...
    methods: {
        getLineData(start, end, subType) {
            return new Promise((resolve, reject) => {
                ...
                this.$post('/apiDataOverview.html?f=getIdentityVerifyGraph', data)
                    .then((response) => {
        ...
        getlist(start, end, subType, page) {
            return new Promise((resolve, reject) => {
                ...
                this.$post('/apiDataOverview.html?f=getIdentityVerifyData', data)
                    .then((response) => {
        ...
        getTopdata() {
            return new Promise((resolve, reject) => {
                this.$post('/apiDataOverview.html?f=getIdentityVerifyToday')
                    .then((response) => {
