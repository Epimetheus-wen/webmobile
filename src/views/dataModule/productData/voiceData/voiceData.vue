      ...
      <div class="prductData_main">
        <div class="prductData_top">
          <div class="prductData_name">
            <img class="img" src="../../../../assets/images/dataModule/voice.png" alt />
            <div class="title">
                ...
                <div class="filter_item_buttom">
                  <div class="select_item select_item2">
                    <van-cell @click="showPopup('account')">
                      <div class="value">
                        <span
                          v-text="account.value==''?account.list[0].task_name:account.value"
                    ...
                    <van-popup v-model="account.show" round position="bottom" class="product_popup">
                      ...
                      <div class="product_popup_center">
                        <div
                          ...
                          :key="index"
                          :class="item.id==account.n?'put_item put_item_ation':'put_item'"
                          @click="accountAction(item.task_name,item.id,index)"
                        >{{item.task_name}}</div>
                      </div>
                    </van-popup>
                  </div>
              ...
              <div class="collect_table">
                ...
                <div class="collect_table—title">
                  ...
                  <!-- <div class="center">
                    ...
                    >
                      ...
                      <div class="product_popup_center">
                        <div class="put_item put_item_ation">全部</div>
                        <div class="put_item">移动</div>
                        <div class="put_item">联通</div>
                        <div class="put_item">电信</div>
                      </div>
                    </van-popup>
                  </div>-->
                  <div class="center">通话总数(条)</div>
                  <div class="right">
                ...
                >
                  <div class="list_item" v-for="(item,index) in employList" :key="index">
                    ...
                    <!-- <div class="center">{{item.operator}}</div> -->
                    <div class="center">{{item.all_sum}}</div>
                    <div class="right" v-show="tablefilter1.value=='成功(条)'">{{item.success_sum}}</div>
                    <div class="right" v-show="tablefilter1.value=='未接通(条)'">{{item.no_answered_sum}}</div>
                    <div class="right" v-show="tablefilter1.value=='未应答(条)'">{{item.no_respond_sum}}</div>
                    <div class="right" v-show="tablefilter1.value=='异常(条)'">{{item.exception_sum}}</div>
                  </div>
                </van-list>
              </div>
            </div>
...
<script src='./voiceData.controller.js'>
</script>
